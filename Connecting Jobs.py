# -*- coding: utf-8 -*-
"""
Created on Sat Nov 19 16:06:31 2022
...
#-----Dr_Lbl-----#
lbl_dr = Label(root, text = "Doctor : ", font = ("Brush Script MT", 15, "bold"), bg = "yellow", fg = "black")
lbl_dr.place(relx = 0.1, rely = 0.3, anchor = CENTER)

#-----IT_Lbl-----#
lbl_it = Label(root, text = "IT Professtional : ", font = ("Brush Script MT", 15, "bold"), bg = "yellow", fg = "black")
lbl_it.place(relx = 0.1, rely = 0.6, anchor = CENTER)

#-----Chemical_Lbl-----#
lbl_chemical = Label(root, text = "Chemical Engineer : ", font = ("Brush Script MT", 15, "bold"), bg = "yellow", fg = "black")
...
#-----Selected_Dr_Lbl-----#
lbl_selected_dr = Label(root, font = ("times", 12, "bold"), bg = "orange", fg = "black")
lbl_selected_dr.place(relx = 0.3, rely = 0.3, anchor = CENTER)

#-----Selected_IT_Lbl-----#
lbl_selected_it = Label(root, font = ("times", 12, "bold"), bg = "orange", fg = "black")
lbl_selected_it.place(relx = 0.3, rely = 0.6, anchor = CENTER)

#-----Selected_Chemical_Lbl-----#
lbl_selected_chemical = Label(root, font = ("times", 12, "bold"), bg = "orange", fg = "black")
...
btn_dr = Button(root, text = "Show the Hospital Alloted", command = child1_obj.get_dr, bg = "pink", relief = FLAT, fg = "black")
btn_dr.place(relx = 0.1, rely = 0.2, anchor = CENTER)

btn_it = Button(root, text = "Show the IT Company Alloted", command = child2_obj.get_it, bg = "pink", relief = FLAT, fg = "black")
btn_it.place(relx = 0.1, rely = 0.5, anchor = CENTER)

btn_chemical = Button(root, text = "Show the Chemical Company Alloted", command = child3_obj.get_chemical, bg = "pink", relief = FLAT, fg = "black")
